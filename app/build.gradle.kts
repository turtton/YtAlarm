...
dependencies {
    ...
    implementation("androidx.navigation:navigation-fragment-ktx:2.9.0")?.version?.also {
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.1")?.also {
        implementation("androidx.lifecycle:lifecycle-livedata-ktx:${it.version}")
    }
    implementation("androidx.activity:activity-ktx:1.10.1")
    implementation("androidx.fragment:fragment-ktx:1.8.8")
    implementation("androidx.work:work-runtime-ktx:2.10.2")?.version?.also {
        androidTestImplementation("androidx.work:work-testing:$it")
    }

    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.10.2")
    implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.8.1")?.version?.also {
